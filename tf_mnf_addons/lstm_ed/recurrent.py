...
import lstm_ed.constraints as constraints
import lstm_ed.initializers as initializers
import lstm_ed.random_variable as random_variable
import lstm_ed.regularizers as regularizers
import functools
...
class LSTMCellReparameterization(tf.keras.layers.LSTMCell):
  ...
  def __init__(self,
               ...
               use_bias=True,
               kernel_initializer='trainable_glorot_normal',
               recurrent_initializer='trainable_glorot_normal',
